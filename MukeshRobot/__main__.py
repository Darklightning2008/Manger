...
PM_START_TEXT = """ 
*ʜᴇʏ* {}, [⚡]({})
*I ᴀᴍ Kakashi Hatake, Tʜᴇ ᴘᴏᴡᴇʀғᴜʟ ʙᴏᴛ
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            update.effective_message.reply_text(PM_START_TEXT.format(escape_markdown(first_name), BOT_NAME, PM_IMG, sql.num_users(), sql.num_chats(), START_IMG),
        ...
        update.effective_message.reply_photo(
            START_IMG,
            caption="ɪ ᴀᴍ ᴀʟɪᴠᴇ ʙᴀʙʏ  !\n<b>ɪ ᴅɪᴅɴ'ᴛ sʟᴇᴇᴘ sɪɴᴄᴇ​:</b> <code>{}</code>".format(
                uptime
            ),
...
def Mukesh_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "mukesh_":
        ...
        query.message.edit_text("**๏ ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʙᴜᴛᴛᴏɴs ɢɪᴠᴇɴ ʙᴇʟᴏᴡ ᴛᴏ ɢᴇᴛ ʜᴇʟᴩ ᴀɴᴅ ᴍᴏʀᴇ ɪɴғᴏʀᴍᴀᴛɪᴏɴ ᴀ**"
            f"\n\nɪғ ʏᴏᴜ ғᴏᴜɴᴅ ᴀɴʏ ʙᴜɢ ɪɴ ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʙᴜᴛᴛᴏɴs ɢɪᴠᴇɴ ʙᴇʟᴏᴡ ᴛᴏ ɢᴇᴛ ʜᴇʟᴩ ᴀɴᴅ ᴍᴏʀᴇ ɪɴғᴏʀᴍᴀᴛɪᴏɴ ᴀ**"
        ...
        InlineKeyboardButton(text="🖥️", callback_data="Main_help"),
                    ...
                    [
                        ...
                        InlineKeyboardButton(
                            text="ɢɪᴛʜᴜʙ 🍹", url="https://github.com/Darklightning2008"
                        ),
                    ],
                    [
...
ꜱᴇᴛ ᴀ ᴡᴇʟᴄᴏᴍᴇ ᴍᴇꜱꜱᴀɢᴇ!""",parse_mode=ParseMode.MARKDOWN,
        ...
        query.message.edit_text(""" 𝙷𝚒 𝚐𝚞𝚢𝚜 𝙸 𝚊𝚖 𝚑𝚊𝚙𝚙𝚢 𝚝𝚑𝚊𝚝 𝚢𝚘𝚞 𝚊𝚛𝚎 𝚠𝚒𝚕𝚕𝚒𝚗𝚐 𝚝𝚘 𝚍𝚘𝚗𝚊𝚝𝚎 𝚝𝚘 𝚖𝚎 𝚝𝚘 𝚍𝚎𝚟𝚎𝚕𝚘𝚙 𝚝𝚑𝚎 𝚋𝚘𝚝 𝚙𝚕𝚎𝚊𝚜𝚎 𝚍𝚘𝚗𝚊𝚝𝚎 𝚋𝚢 𝚌𝚕𝚒𝚌𝚔𝚒𝚗𝚐 
@Speedy208.𝙿𝚕𝚎𝚊𝚜𝚎 𝚜𝚑𝚊𝚛𝚎 𝚊𝚗𝚍 𝚜𝚞𝚙𝚙𝚘𝚛𝚝 𝚖𝚎 𝚋𝚢 𝚜𝚑𝚊𝚛𝚒𝚗𝚐 𝚖𝚎 𝚊𝚗𝚍 𝚘𝚗𝚌𝚎 𝚊𝚐𝚊𝚒𝚗 𝚝𝚑𝚊𝚗𝚔 𝚢𝚘𝚞 ❤🌹🙏 """,parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [ [
        InlineKeyboardButton(text="🏡", callback_data="mukesh_back"),
        ...
        InlineKeyboardButton(text="🖥️", callback_data="Main_help"),
                    ...
                    [
                        InlineKeyboardButton(text="• Dᴏɴᴀᴛᴇ •", url="https://t.me/speedy208"),InlineKeyboardButton(text="• sᴜᴘᴘᴏʀᴛ •", callback_data="mukesh_support")
                    ]
                ]
            ),
            )
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 1929914544 and DONATION_LINK:
            update.effective_message.reply_text(
                f"» ᴛʜᴇ ᴅᴇᴠᴇʟᴏᴩᴇʀ ᴏғ {dispatcher.bot.first_name} sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ ɪs [ɢɪᴛʜᴜʙ](https://github.com/Darklightning2008/Manger)"
...
━━━━━━━━━━━━━
**ᴍᴀᴅᴇ ᴡɪᴛʜ ❤️ 𝐒𝐩𝐞𝐞𝐝𝐲**
**Vᴇʀsɪᴏɴ Nᴜᴍʙᴇʀ:V1.0.1
**Vᴇʀsɪᴏɴ Nᴀᴍᴇ:𝐍𝐢𝐧𝐣𝐚 𝐕𝐞𝐫𝐬𝐢𝐨𝐧
**Pʀᴏɢʀᴀᴍ Vᴇʀsɪᴏɴ:2.0.016
**Lɪʙʀᴀʀʏ Vᴇʀsɪᴏɴ:3.15
━━━━━━━━━━━━━
""",reply_markup=x,
                parse_mode=ParseMode.MARKDOWN,
            )
